...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Mohit Pathak";
        $("#favicon").attr("href","assests/images/mohit pathak.png");
    }
    else {
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["Software Development", "Full-Stack development"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
...
// s1.async=true;
// s1.src='https://embed.tawk.to/6303a7b137898912e9647aeb/1gb34ti08';
// s1.charset='UTF-8';
